# from config_new import remote_gwsis_dbname, remote_gwsis_dbuser, remote_gwsis_dbpwd
...
# Database Setup
#################################################
# config_new = "../../../opt/anaconda3/lib/python3.7/site-packages/config_new.py"
...
app.config= "sqlite://bellybutton.sqlite"
db = SQLAlchemy(app)
